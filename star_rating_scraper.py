"""
star_rating_scraper.py — Star rating + delivery date scraper for Project Pipeline.

Adapted from AX-Scraper scr04.py.
Scrapes: star rating, delivery date, price, quantity, ship_country per product ID.
...
------------------------------------------
  scrape_product_details(product_id)         — scrape a single product
  scrape_product_details_bulk(product_ids)   — scrape a list of product IDs
